...
import com.joshtalks.joshskills.buypage.databinding.FragmentBookACallBinding
...
import com.joshtalks.joshskills.buypage.new_buy_page_layout.model.SalesReasonList
...
class BookACallFragment : BaseFragment() {
    ...
    fun submitReason() {
        if (binding.phoneNumberEt.text.isNullOrEmpty() ||
            isValidFullNumber("+91", binding.phoneNumberEt.text.toString()).not() ||
            binding.phoneNumberEt.text.toString().length < 10
        ) {
