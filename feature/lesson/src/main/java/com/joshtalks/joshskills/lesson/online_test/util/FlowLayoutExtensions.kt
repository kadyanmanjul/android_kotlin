...
fun FlowLayout.removeView(view: View, choice: Choice) {
    ...
    atsOptionView.setPadding(
        com.joshtalks.joshskills.lesson.online_test.vh.AtsOptionView.mPaddingLeft,
        com.joshtalks.joshskills.lesson.online_test.vh.AtsOptionView.mPaddingTop,
        com.joshtalks.joshskills.lesson.online_test.vh.AtsOptionView.mPaddingRight,
        com.joshtalks.joshskills.lesson.online_test.vh.AtsOptionView.mPaddingBottom
    )
    invalidate()
