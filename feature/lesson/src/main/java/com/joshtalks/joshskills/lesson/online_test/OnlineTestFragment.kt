...
import com.joshtalks.joshskills.lesson.online_test.vh.GrammarButtonView
import com.joshtalks.joshskills.lesson.online_test.vh.McqChoiceView
import com.joshtalks.joshskills.lesson.online_test.vh.SubjectiveChoiceView
import com.joshtalks.joshskills.lesson.online_test.util.*
...
class OnlineTestFragment :
    ...
    private var audioManager: com.joshtalks.joshskills.common.util.ExoAudioPlayer2? = null
    ...
    override fun onCreateView(
        ...
        audioManager = com.joshtalks.joshskills.common.util.ExoAudioPlayer2.getInstance()
        return binding.root
    }
