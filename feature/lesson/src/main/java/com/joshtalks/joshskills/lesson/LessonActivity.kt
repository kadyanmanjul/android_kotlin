...
import com.joshtalks.joshskills.lesson.databinding.LessonActivityBinding
                    ...
                    videoView.apply {
                        ...
                        setPlayerCompletionCallback {
                            if (it.id != INTRO_VIDEO_ID) {
                                ...
                                A2C1Impressions.saveImpression(
                                    A2C1Impressions.Impressions.RULE_VIDEO_COMPLETED)
                            }
                        }
                        seekToStart()
                        downloadStreamPlay()
