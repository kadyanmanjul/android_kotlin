...
import com.joshtalks.joshskills.certificate.databinding.ActivityCertificationBaseBinding
...
class CertificationBaseActivity : BaseActivity() {
    ...
    private lateinit var binding:ActivityCertificationBaseBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_certification_base)
        initView()
