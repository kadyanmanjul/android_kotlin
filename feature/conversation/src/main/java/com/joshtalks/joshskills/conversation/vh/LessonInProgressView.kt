...
import com.joshtalks.joshskills.common.core.extension.setImageInLessonView
...
class LessonInProgressView : FrameLayout {
    ...
    private fun init() {
        ...
        rootView.setOnClickListener {
            lessonModel?.let {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(LessonItemClickEventBus(it.id, it.isNewGrammar))
            }
        }
