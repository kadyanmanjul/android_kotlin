...
class ConversationViewModel(
    ...
    val singleLiveEvent = com.joshtalks.joshskills.common.base.EventLiveData
    val msg = Message()
            ...
            try {
                if (Utils.isInternetAvailable().not()) {
                    withContext(dispatcher) {
                        msg.what = com.joshtalks.joshskills.common.constants.INTERNET_FAILURE
                ...
                withContext(dispatcher) {
                    msg.what = com.joshtalks.joshskills.common.constants.COURSE_RESTART_SUCCESS
                    singleLiveEvent.value = msg
                }
            } catch (ex: Throwable) {
                withContext(dispatcher) {
