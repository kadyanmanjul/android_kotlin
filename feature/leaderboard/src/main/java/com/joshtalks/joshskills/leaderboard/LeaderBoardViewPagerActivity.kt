...
import com.joshtalks.joshskills.leaderboard.databinding.ActivityLeaderboardViewPagerBinding
...
//            delay(6500)
    ...
    override fun onViewBitmap(overlayItem: TooltipUtils.ItemOverlay, type: String, arrowPosition: Float?) {
