...
class ProfileImageShowFragment : DialogFragment() {
    ...
    lateinit var viewPagerAdapter: com.joshtalks.joshskills.userprofile.adapters.ViewPagerAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewPagerAdapter = com.joshtalks.joshskills.userprofile.adapters.ViewPagerAdapter(
