...
import com.joshtalks.joshskills.userprofile.utils.MY_GROUP
import com.joshtalks.joshskills.userprofile.utils.USER_PROFILE_BACK_STACK
...
class UserProfileActivity : CoreJoshActivity() {
    ...
    private fun initToolbar() {
        ...
        if (mentorId == Mentor.getInstance().getId()) {
            ...
            findViewById<View>(R.id.iv_edit).visibility = View.GONE
        }
        findViewById<View>(R.id.iv_setting).visibility = View.VISIBLE
    ...
    private fun initView(userData: UserProfileResponse) {
        ...
        this.resp = resp
        binding.textMessageTitle.text = resp
