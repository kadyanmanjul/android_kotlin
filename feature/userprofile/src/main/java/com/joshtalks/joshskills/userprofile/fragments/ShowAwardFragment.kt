...
import com.joshtalks.joshskills.userprofile.databinding.FragmentAwardShowBinding
...
class ShowAwardFragment : DialogFragment() {
    ...
    private val viewModel by lazy { ViewModelProvider(requireActivity()).get(com.joshtalks.joshskills.userprofile.viewmodel.UserProfileViewModel::class.java) }
