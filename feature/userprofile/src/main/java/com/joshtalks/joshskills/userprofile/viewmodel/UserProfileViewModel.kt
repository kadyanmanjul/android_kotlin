package com.joshtalks.joshskills.userprofile.viewmodel
...
import com.joshtalks.joshskills.userprofile.adapters.EnrolledCoursesListAdapter
import com.joshtalks.joshskills.userprofile.adapters.MyGroupsListAdapter
...
class UserProfileViewModel(application: Application) : AndroidViewModel(application) {
                ...
                if (response != null) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            if (isSaveBtnClicked) {
                                com.joshtalks.joshskills.common.messaging.RxBus2.publish(SaveProfileClickedEvent(true))
                            }
                            getProfileData(mentorId, intervalType, previousPage)
            ...
            try {
                ...
                if (response.isSuccessful && response.body()?.groupsList?.myGroupsList != null) {
                    ...
                    withContext(Dispatchers.Main) {
                        message.what = com.joshtalks.joshskills.common.constants.MY_GROUP_LIST_DATA
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    withContext(Dispatchers.Main) {
                        message.what = com.joshtalks.joshskills.common.constants.COURSE_LIST_DATA
    ...
    fun onBackPress(view: View) {
        message.what = com.joshtalks.joshskills.common.constants.ON_BACK_PRESS_PROFILE
        singleLiveEvent.value = message
    }
    ...
    fun inviteFriends(packageString: String? = null, dynamicLink: String) {
        try {
            ...
            message.what = com.joshtalks.joshskills.common.constants.INVITE_FRIENDS_METHOD
