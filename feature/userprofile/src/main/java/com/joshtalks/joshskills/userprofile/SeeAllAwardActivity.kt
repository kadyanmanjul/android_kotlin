...
import com.joshtalks.joshskills.common.ui.userprofile.models.AwardCategory
import com.joshtalks.joshskills.common.track.CONVERSATION_ID
import com.joshtalks.joshskills.userprofile.databinding.FragmentSeeAllAwardBinding
...
class SeeAllAwardActivity : BaseActivity() {
    ...
    private val viewModel by lazy {
        ViewModelProvider(this).get(
            com.joshtalks.joshskills.userprofile.viewmodel.UserProfileViewModel::class.java
        )
    }
    ...
    private fun initToolbar() {
        findViewById<View>(com.joshtalks.joshskills.common.R.id.iv_back).visibility = View.VISIBLE
        findViewById<View>(com.joshtalks.joshskills.common.R.id.iv_back).setOnClickListener {
            onBackPressed()
        }
        findViewById<View>(com.joshtalks.joshskills.common.R.id.iv_help).visibility = View.VISIBLE
        findViewById<View>(com.joshtalks.joshskills.common.R.id.iv_help).setOnClickListener {
            MixPanelTracker.publishEvent(MixPanelEvent.BACK).push()
            openHelpActivity()
        }
        findViewById<TextView>(com.joshtalks.joshskills.common.R.id.text_message_title).text = getString(R.string.awards)
    }
