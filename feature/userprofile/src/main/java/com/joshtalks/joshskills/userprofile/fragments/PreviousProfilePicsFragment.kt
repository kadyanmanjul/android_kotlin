...
import com.joshtalks.joshskills.common.ui.userprofile.models.PreviousProfilePictures
import com.joshtalks.joshskills.common.ui.userprofile.models.ProfilePicture
import com.joshtalks.joshskills.userprofile.R
import com.joshtalks.joshskills.userprofile.databinding.FragmentPreviousProfilePicsBinding
...
class PreviousProfilePicsFragment : DialogFragment() {
    ...
    private fun initView(previousProfilePics: PreviousProfilePictures) {
        scope.launch {
            val imagesUrls : Array<String> = Array(previousProfilePics.profilePictures.size){""}
            var count=0
            previousProfilePics.profilePictures.forEach{
                imagesUrls[count] = it.photoUrl
                count++
            }
            val imageIds : Array<String> = Array(previousProfilePics.profilePictures.size){""}
            count=0
            previousProfilePics.profilePictures.forEach{
            ...
            previousProfilePics.profilePictures.sortedBy { it.timestamp?.time }
                .let { picsList ->
                    withContext(Dispatchers.Main) {
                        ...
                        recyclerView.adapter = com.joshtalks.joshskills.userprofile.adapters.PreviousPicsAdapter(
                            picsList,
                            object :
                                com.joshtalks.joshskills.userprofile.adapters.PreviousPicsAdapter.OnPreviousPicClickListener {
    ...
    private suspend fun setImageUrls(previousProfilePics: PreviousProfilePictures) {
