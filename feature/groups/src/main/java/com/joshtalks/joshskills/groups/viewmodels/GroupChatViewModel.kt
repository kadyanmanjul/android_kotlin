package com.joshtalks.joshskills.groups.viewmodels
...
import com.joshtalks.joshskills.groups.adapters.GroupChatAdapter
import com.joshtalks.joshskills.groups.adapters.GroupMemberAdapter
...
import com.joshtalks.joshskills.groups.model.LeaveGroupRequest
...
import com.joshtalks.joshskills.groups.utils.GroupChatComparator
import com.joshtalks.joshskills.groups.utils.getMemberCount
import com.joshtalks.joshskills.groups.utils.pushMetaMessage
import com.joshtalks.joshskills.groups.utils.pushTimeMetaMessage
...
class GroupChatViewModel : com.joshtalks.joshskills.common.base.BaseViewModel() {
    ...
    val chatAdapter = GroupChatAdapter(GroupChatComparator).apply {
        registerAdapterDataObserver(object : RecyclerView.AdapterDataObserver() {
            override fun onItemRangeInserted(positionStart: Int, itemCount: Int) {
                ...
                message.what = com.joshtalks.joshskills.common.constants.NEW_CHAT_ADDED
                val bundle = Bundle()
    ...
    fun callGroup() {
        ...
        message.what = com.joshtalks.joshskills.common.constants.OPEN_CALLING_ACTIVITY
        message.data = Bundle().apply {
            ...
            if (groupId == DM_CHAT)
                putInt(com.joshtalks.joshskills.common.track.AGORA_UID, agoraId)
        }
        singleLiveEvent.value = message
    }
    ...
    fun joinGroup(view: View) {
        if (groupType.get() == CLOSED_GROUP && groupJoinStatus.get() == "REQUEST TO JOIN") {
            MixPanelTracker.publishEvent(MixPanelEvent.REQUEST_TO_JOIN_GROUP)
                ...
                .push()
            message.what = com.joshtalks.joshskills.common.constants.OPEN_GROUP_REQUEST
            singleLiveEvent.value = message
    ...
    fun validateJoinRequest(view: View) {
        message.what = com.joshtalks.joshskills.common.constants.REQUEST_GROUP_VALIDATION
        singleLiveEvent.value = message
    }
    ...
    fun openEmojiKeyboard(isFromKeyboard: Boolean) {
        message.what = com.joshtalks.joshskills.common.constants.OPEN_EMOJI_KEYBOARD
        message.data = Bundle().apply {
    ...
    fun openGroupInfo() {
        if (groupType.get() == DM_CHAT) {
            message.what = com.joshtalks.joshskills.common.constants.OPEN_PROFILE_DM_FPP
            singleLiveEvent.value = message
        } else {
            if (hasJoinedGroup.get()) {
                message.what = com.joshtalks.joshskills.common.constants.OPEN_GROUP_INFO
                singleLiveEvent.value = message
    ...
    fun openRequestList(view: View) {
        message.what = com.joshtalks.joshskills.common.constants.OPEN_GROUP_REQUESTS_LIST
        message.obj = groupId
        singleLiveEvent.value = message
    ...
    fun editGroupInfo() {
        MixPanelTracker.publishEvent(MixPanelEvent.EDIT_GROUP_INFO_CLICKED)
            .addParam(ParamKeys.GROUP_ID, groupId)
            .push()
        message.what = com.joshtalks.joshskills.common.constants.EDIT_GROUP_INFO
        message.data = Bundle().apply {
    ...
    fun onRemoveFpp() {
        message.what = com.joshtalks.joshskills.common.constants.REMOVE_DM_FPP
        singleLiveEvent.value = message
    }
    ...
    fun sendMessage(view: View) {
        if (Utils.isInternetAvailable()){
            ...
            MixPanelTracker.publishEvent(MixPanelEvent.GROUP_MESSAGE_SENT)
                .addParam(ParamKeys.GROUP_ID, groupId)
                .push()
            message.what = com.joshtalks.joshskills.common.constants.SEND_MSG
            singleLiveEvent.value = message
        }else{
    ...
    private fun clearText() {
        message.what = com.joshtalks.joshskills.common.constants.CLEAR_CHAT_TEXT
        singleLiveEvent.value = message
    }
