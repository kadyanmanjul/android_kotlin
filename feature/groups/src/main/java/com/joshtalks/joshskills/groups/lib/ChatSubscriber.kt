...
import com.joshtalks.joshskills.groups.constants.FROM_BACKEND_MSG_TIME
import com.joshtalks.joshskills.groups.constants.RECEIVE_META_MESSAGE_LOCAL
import com.joshtalks.joshskills.groups.constants.SENT_META_MESSAGE_LOCAL
...
import com.joshtalks.joshskills.groups.utils.getLastMessage
import com.joshtalks.joshskills.groups.utils.getMessageType
...
object ChatSubscriber : SubscribeCallback() {
    ...
    override fun membership(pubnub: PubNub, pnMembershipResult: PNMembershipResult) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (event == "set") {
                database.groupMemberDao().insertMember(
                    GroupMember(
                    mentorID = mentorId,
