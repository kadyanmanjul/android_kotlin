...
internal class NotificationGenerator(private val applicationContext: Context) {
...
//                        .setSmallIcon(R.drawable.common_google_signin_btn_icon_light_focused)
                        .setContentTitle(
                            notificationObj.getCallDetails()[applicationContext.getString(
                        ...
                        .addAction(
                            0,
                            applicationContext.getString(R.string.accept_call),
                            acceptPendingIntent
                        )
                        .addAction(
                            0,
                            applicationContext.getString(R.string.reject_call),
                            rejectPendingIntent
                        )
                        .setOngoing(true)
...
//            }
    ...
    fun updateNotification(
        ...
        NotificationManagerCompat.from(applicationContext)
            .notify(notificationId, notificationBuiltObj.build())
    }
