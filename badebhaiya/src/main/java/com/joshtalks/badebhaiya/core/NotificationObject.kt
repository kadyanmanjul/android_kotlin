...
enum class NotificationAction(val type: String) {
    ...
    @SerializedName("ROOM_REQUEST_NOTIFICATION")
    ROOM_REQUEST_NOTIFICATION("ROOM_REQUEST_NOTIFICATION"),

    @SerializedName("SPEAKER_GOT_FOLLOWED")
    SPEAKER_GOT_FOLLOWED("SPEAKER_GOT_FOLLOWED"),
