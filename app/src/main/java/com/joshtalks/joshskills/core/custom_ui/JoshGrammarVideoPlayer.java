...
public class JoshGrammarVideoPlayer extends PlayerView implements View.OnTouchListener, View.OnClickListener {
    ...
    public JoshGrammarVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public JoshGrammarVideoPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public JoshGrammarVideoPlayer(Context context) {
        super(context);
        init();
    }
    ...
    public void setPlayListener(PlayerFullScreenListener playerFullScreenListener) {
        ...
        findViewById(R.id.close_iv).setVisibility(VISIBLE);
    ...
    public void onClick(View v) {
        try {
            ...
            if (v.getId() == R.id.ivFullScreenToggle) {
                ...
                if (playerFullScreenListener != null) {
                    playerFullScreenListener.onClose();
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
