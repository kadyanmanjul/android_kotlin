...
enum class AnalyticsEvent(val NAME: String) {
    ...
    REFER_INBOX_ICON_CLICKED("Refer Inbox Icon Clicked V3"),
    REFER_BUTTON_CONVERSATION_MENU("Refer Button Conversation Menu V3"),
    REFER_CONVERSATION_ICON_CLICKED("Refer Conversation Icon Clicked V3"),
