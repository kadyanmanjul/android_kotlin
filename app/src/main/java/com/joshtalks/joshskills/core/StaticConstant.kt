...
class FirebaseRemoteConfigKey {
    companion object {
        ...
        const val CERTIFICATE_SHARE_TEXT = "CERTIFICATE_SHARE_TEXT"
        const val CERTIFICATE_SHARE_TEXT_WHATSAPP = "CERTIFICATE_SHARE_TEXT"
        const val CERTIFICATE_SHARE_TEXT_FB = "CERTIFICATE_SHARE_TEXT"
        const val CERTIFICATE_SHARE_TEXT_LINKEDIN = "CERTIFICATE_SHARE_TEXT"
        const val CERTIFICATE_SHARE_TEXT_INSTA = "CERTIFICATE_SHARE_TEXT"
