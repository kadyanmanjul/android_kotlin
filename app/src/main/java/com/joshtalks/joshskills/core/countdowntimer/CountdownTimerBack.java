...
public abstract class CountdownTimerBack implements CountDownTimerListener {
    ...
    public CountdownTimerBack() {
        init(0, INTERVAL);
    }

    public CountdownTimerBack(long timeInMillis) {
        init(timeInMillis, INTERVAL);
    }

    public CountdownTimerBack(long timeInMillis, long intervalInMillis) {
