...
import com.joshtalks.joshskills.databinding.FragmentFragReportOverView1Binding
...
class FragReportOverView1(val certificateExamReport: CertificateExamReportModel, val examType:String?) : Fragment() {
