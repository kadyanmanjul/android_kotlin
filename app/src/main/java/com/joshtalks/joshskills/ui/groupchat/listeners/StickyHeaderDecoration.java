...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private RecyclerView.ViewHolder getHeader(RecyclerView var1, int var2) {
        ...
        if (this.mHeaderCache.containsKey(var3)) {
            ...
            int var7 = MeasureSpec.makeMeasureSpec(var1.getMeasuredWidth(), MeasureSpec.AT_MOST);
            int var8 = MeasureSpec.makeMeasureSpec(var1.getMeasuredHeight(), MeasureSpec.UNSPECIFIED);
