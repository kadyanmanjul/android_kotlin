...
class InboxAdapter(private var lifecycleProvider: LifecycleOwner) :
    PagingDataAdapter<InboxEntity, InboxAdapter.InboxViewHolder>(POST_COMPARATOR) {
...
/*
    ...
    companion object {
        val POST_COMPARATOR = object : DiffUtil.ItemCallback<InboxEntity>() {
            override fun areContentsTheSame(oldItem: InboxEntity, newItem: InboxEntity): Boolean =
                oldItem == newItem

            override fun areItemsTheSame(oldItem: InboxEntity, newItem: InboxEntity): Boolean =
