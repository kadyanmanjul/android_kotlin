...
class SearchingOpponentTeamFragmentFpp : Fragment(), GameFirebaseDatabase.OnNotificationTrigger,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            gameFirebaseDatabase.getCurrentUserRoomId(Mentor.getInstance().getId(), this)
        } catch (ex: Exception) {
            Timber.d(ex)
        }
    ...
    companion object {
        ...
        fun newInstance(param1: String, userDetails: UserDetails?, channelName: String?) =
            SearchingOpponentTeamFragmentFpp().apply {
    ...
    private fun setupViewModel() {
        ...
        searchOpponentTeamViewModel = factory?.let {
            ViewModelProvider(this, it).get(SearchOpponentTeamViewModelGame::class.java)
        }
