...
class QuestionViewModelGame(var questionViewModelApplication: Application) :
    GameBaseViewModel(questionViewModelApplication) {

    val questionRepo = QuestionRepo(RetrofitInstance.getRetrofitInstance())
