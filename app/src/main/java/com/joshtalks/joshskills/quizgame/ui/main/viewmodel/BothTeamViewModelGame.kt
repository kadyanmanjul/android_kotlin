...
class BothTeamViewModelGame(var bothTeamViewModelApplication: Application) : GameBaseViewModel(bothTeamViewModelApplication) {
    val bothTeamRepo = BothTeamRepo(RetrofitInstance.getRetrofitInstance())
