...
import com.joshtalks.joshskills.quizgame.ui.data.repository.SearchingTeamFromFpp
import com.joshtalks.joshskills.quizgame.util.UpdateReceiver
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import timber.log.Timber

class SearchOpponentTeamViewModelGame(var SearchOpponentTeamVm: Application) :
    GameBaseViewModel(SearchOpponentTeamVm) {
    var searchOpponentRepo = SearchingTeamFromFpp(RetrofitInstance.getRetrofitInstance())
