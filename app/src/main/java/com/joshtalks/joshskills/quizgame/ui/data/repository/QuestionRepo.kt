...
class QuestionRepo {
    suspend fun getQuestion(questionRequest: QuestionRequest) = RetrofitInstanse.getRetrofitInstance()?.getQuestionList(questionRequest)
    suspend fun getSelectAnswer(roomId:String,questionId:String,choiceId:String,teamId:String) = RetrofitInstanse.getRetrofitInstance()?.getSelectAnswer(SelectOption(roomId,questionId,choiceId,teamId))
    suspend fun getDisplayCorrectAnswer(roomId:String,questionId:String) = RetrofitInstanse.getRetrofitInstance()?.getDisplayData(DisplayAnswer(roomId,questionId))
