...
import com.joshtalks.joshskills.quizgame.ui.main.viewmodel.BothTeamViewModelGame
...
class BothTeamMateFoundFpp : Fragment(), P2pRtc.WebRtcEngineCallback, GameFirebaseDatabase.OnTimeChange {
    ...
    var bothTeamViewModel: BothTeamViewModelGame? = null
    ...
    private fun setupViewModel() {
        ...
        bothTeamViewModel = factory?.let {
            ViewModelProvider(this, it).get(BothTeamViewModelGame::class.java)
        }
    ...
    private fun moveFragment(time: Long) {
        val timeForDelay = (time - (System.currentTimeMillis() / 1000 % 60)) % 60
