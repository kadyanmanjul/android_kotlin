 ...
 * recyclerView.addItemDecoration(RecyclerViewCarouselItemDecorator(activity, cardWidthPixels, 0.01f))
 * ```
 */
open class RecyclerViewCarouselItemDecorator : RecyclerView.ItemDecoration {
    ...
    private fun isLastItem(index: Int, recyclerView: RecyclerView) =
        index == (recyclerView.adapter?.itemCount ?: 1) - 1
}
