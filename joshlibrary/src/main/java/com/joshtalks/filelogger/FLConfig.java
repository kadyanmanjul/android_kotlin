...
import static com.joshtalks.filelogger.FLConst.RetentionPolicy.FILE_COUNT;
import static com.joshtalks.filelogger.FLConst.RetentionPolicy.TOTAL_SIZE;
...
public class FLConfig {
    ...
    public static class Builder {
        ...
        /**
         * Defines the minimum logging level. Default is
         *
         * @param level
         * @return
         */
         ...
         *
         * @param retentionPolicy For possible values refer to
         * @return
         */
