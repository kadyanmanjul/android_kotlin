...
public class OtpTextView extends FrameLayout {
    ...
    private void generateViews(TypedArray styles, AttributeSet attrs) {
        ...
        if (length > 0) {
            ...
            boolean cursorVisible=styles.getBoolean(R.styleable.OtpTextView_cursor_visible,false);
    ...
    private void setTextWatcher(final OTPChildEditText otpChildEditText) {
