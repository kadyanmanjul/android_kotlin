...
import com.joshtalks.joshskills.premium.databinding.FragmentSignUpOptionsBinding
...
class SignUpOptionsFragment : BaseSignUpFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (com.joshtalks.joshskills.premium.core.PrefManager.getBoolValue(
                com.joshtalks.joshskills.premium.core.IS_PAYMENT_DONE
            ) &&
            ...
            val mobileNumber = com.joshtalks.joshskills.premium.core.PrefManager.getStringValue(
                com.joshtalks.joshskills.premium.core.PAYMENT_MOBILE_NUMBER
            ).split(
                SINGLE_SPACE
            )
