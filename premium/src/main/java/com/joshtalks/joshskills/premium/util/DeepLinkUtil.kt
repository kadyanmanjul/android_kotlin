...
import com.joshtalks.joshskills.premium.repository.server.LinkAttribution
import com.joshtalks.joshskills.premium.ui.referral.USER_SHARE_SHORT_URL
    ...
    fun build() {
        ...
        branchUniversalObject
            .generateShortUrl(context, lp) { url, error ->
                val deepLink = when {
                    error == null -> url
                    com.joshtalks.joshskills.premium.core.PrefManager.hasKey(USER_SHARE_SHORT_URL) -> com.joshtalks.joshskills.premium.core.PrefManager.getStringValue(
