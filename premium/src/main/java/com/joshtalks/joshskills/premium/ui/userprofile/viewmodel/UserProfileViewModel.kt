package com.joshtalks.joshskills.premium.ui.userprofile.viewmodel
...
import com.joshtalks.joshskills.premium.constants.INVITE_FRIENDS_METHOD
...
import com.joshtalks.joshskills.premium.repository.server.AnimatedLeaderBoardResponse
import com.joshtalks.joshskills.premium.ui.userprofile.adapters.EnrolledCoursesListAdapter
import com.joshtalks.joshskills.premium.ui.userprofile.adapters.MyGroupsListAdapter
import com.joshtalks.joshskills.premium.ui.userprofile.models.*
import com.joshtalks.joshskills.premium.ui.userprofile.repository.UserProfileRepo
import com.joshtalks.joshskills.premium.ui.voip.favorite.FavoriteCallerRepository
                ...
                if (response != null) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            getProfileData(mentorId, intervalType, previousPage)
                            com.joshtalks.joshskills.premium.core.PrefManager.put(USER_NAME,updateProfilePayload.basicDetails?.firstName?: EMPTY)
                            com.joshtalks.joshskills.premium.core.PrefManager.put(USER_PROFILE,updateProfilePayload.basicDetails?.photoUrl?: EMPTY)
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    if (mentorId.equals(Mentor.getInstance().getId()))
                        com.joshtalks.joshskills.premium.core.PrefManager.put(
                            com.joshtalks.joshskills.premium.core.IS_PROFILE_FEATURE_ACTIVE, response.body()?.isPointsActive ?: false
                        )
                    if (mentorId.equals(Mentor.getInstance().getId()))
                        com.joshtalks.joshskills.premium.core.PrefManager.put(
                            com.joshtalks.joshskills.premium.core.USER_SCORE, response.body()!!.points.toString())
