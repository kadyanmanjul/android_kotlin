...
import com.joshtalks.joshskills.premium.databinding.PracticeAudioItemBinding
...
import com.joshtalks.joshskills.premium.repository.local.entity.PracticeEngagementWrapper
    ...
    inner class PracticeAudioViewHolder(val view: PracticeAudioItemBinding) :
        ...
        fun bind(engagement: PracticeEngagementWrapper, position: Int) {
            ...
            ivCancel.setOnClickListener {
                RxBus2.publish(RemovePracticeAudioEventBus(position))
            }
