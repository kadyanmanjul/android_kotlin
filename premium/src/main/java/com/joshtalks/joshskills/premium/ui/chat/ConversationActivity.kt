package com.joshtalks.joshskills.premium.ui.chat
...
import com.joshtalks.joshskills.premium.constants.COURSE_RESTART_SUCCESS
import com.joshtalks.joshskills.premium.constants.INTERNET_FAILURE
...
import com.joshtalks.joshskills.premium.core.Utils.getCurrentMediaVolume
...
import com.joshtalks.joshskills.premium.core.custom_ui.decorator.SmoothScrollingLinearLayoutManager
import com.joshtalks.joshskills.premium.core.custom_ui.exo_audio_player.AudioPlayerEventListener
import com.joshtalks.joshskills.premium.core.extension.setImageWithPlaceholder
import com.joshtalks.joshskills.premium.core.extension.setResourceImageDefault
import com.joshtalks.joshskills.premium.core.extension.slideOutAnimation
import com.joshtalks.joshskills.premium.core.interfaces.OnDismissWithSuccess
import com.joshtalks.joshskills.premium.core.io.AppDirectory
import com.joshtalks.joshskills.premium.core.notification.HAS_COURSE_REPORT
import com.joshtalks.joshskills.premium.core.playback.PlaybackInfoListener.State.PAUSED
import com.joshtalks.joshskills.premium.core.service.video_download.VideoDownloadController
import com.joshtalks.joshskills.premium.databinding.ActivityConversationBinding
...
import com.joshtalks.joshskills.premium.repository.local.eventbus.*
...
import com.joshtalks.joshskills.premium.repository.server.chat_message.TAudioMessage
import com.joshtalks.joshskills.premium.repository.server.chat_message.TChatMessage
import com.joshtalks.joshskills.premium.repository.server.chat_message.TImageMessage
...
import com.joshtalks.joshskills.premium.ui.certification_exam.CertificationBaseActivity
import com.joshtalks.joshskills.premium.ui.chat.adapter.ConversationAdapter
import com.joshtalks.joshskills.premium.ui.chat.service.DownloadMediaService
import com.joshtalks.joshskills.premium.ui.course_progress_new.CourseProgressActivityNew
import com.joshtalks.joshskills.premium.ui.extra.ImageShowFragment
...
import com.joshtalks.joshskills.premium.ui.group.analytics.GroupAnalytics.Event.MAIN_GROUP_ICON
import com.joshtalks.joshskills.premium.ui.leaderboard.ItemOverlay
import com.joshtalks.joshskills.premium.ui.leaderboard.constants.HAS_SEEN_UNLOCK_CLASS_ANIMATION
...
import com.joshtalks.joshskills.premium.ui.pdfviewer.PdfViewerActivity
import com.joshtalks.joshskills.premium.ui.referral.ReferralActivity
import com.joshtalks.joshskills.premium.ui.special_practice.SpecialPracticeActivity
import com.joshtalks.joshskills.premium.ui.special_practice.utils.SPECIAL_ID
...
import com.joshtalks.joshskills.premium.ui.userprofile.models.UserProfileResponse
import com.joshtalks.joshskills.premium.ui.video_player.VIDEO_OBJECT
...
import com.joshtalks.joshskills.premium.util.StickyHeaderDecoration
...
//                                .start(ImagePicker.REQUEST_CODE)
    ...
    override fun onResume() {
        ...
        Log.e("sagar", "onResume: ${PrefManager.getBoolValue(IS_FREE_TRIAL)} ${!PrefManager.getBoolValue(
            IS_COURSE_BOUGHT
        )}", )
        if (inboxEntity.isCapsuleCourse && inboxEntity.isCourseBought.not())
    ...
    private fun showBottomCouponBanner() {
        ...
        if (conversationViewModel.repository.isVariantActive(VariantKeys.L2_LESSON_COMPLETE_ENABLED)) {
            conversationViewModel.getCompletedLessonCount(
