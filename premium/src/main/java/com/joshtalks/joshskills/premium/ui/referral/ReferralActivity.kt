package com.joshtalks.joshskills.premium.ui.referral
...
import com.joshtalks.joshskills.premium.databinding.ActivityReferralBinding
...
class ReferralActivity : BaseActivity() {
    ...
    fun inviteFriends(packageString: String? = null, dynamicLink: String) {
        var referralText = if(com.joshtalks.joshskills.premium.core.PrefManager.getStringValue(
                com.joshtalks.joshskills.premium.core.CURRENT_COURSE_ID
            ) == com.joshtalks.joshskills.premium.core.DEFAULT_COURSE_ID || com.joshtalks.joshskills.premium.core.PrefManager.getBoolValue(
                com.joshtalks.joshskills.premium.core.IS_HINDI_SELECTED
            ) || com.joshtalks.joshskills.premium.core.PrefManager.getBoolValue(
                com.joshtalks.joshskills.premium.core.IS_HINGLISH_SELECTED
            ))
