...
import com.joshtalks.joshskills.premium.databinding.FragmentEnterReferralCodeBinding
    ...
    fun validateAndMoveToNextFragment() {
        CoroutineScope(Dispatchers.Main).launch(Dispatchers.Main) {
            ...
            try {
                ...
                data["gaid"] = com.joshtalks.joshskills.premium.core.PrefManager.getStringValue(
                ...
                if (res.referralStatus) {
                    ...
                    com.joshtalks.joshskills.premium.core.PrefManager.put(
                        com.joshtalks.joshskills.premium.core.REFERRED_REFERRAL_CODE, data["coupon"].toString())
