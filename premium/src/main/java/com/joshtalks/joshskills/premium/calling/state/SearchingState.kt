...
import com.joshtalks.joshskills.premium.calling.Utils.Companion.ignoreException
import com.joshtalks.joshskills.premium.calling.communication.constants.ServerConstants
import com.joshtalks.joshskills.premium.calling.communication.model.ChannelData
import com.joshtalks.joshskills.premium.calling.communication.model.NetworkAction
import com.joshtalks.joshskills.premium.calling.communication.model.Timeout
import com.joshtalks.joshskills.premium.calling.communication.model.UserAction
import com.joshtalks.joshskills.premium.calling.mediator.UserBlockedException
            ...
            try {
                loop@ while (true) {
                    ...
                    when (event.type) {
                        ...
                        TOPIC_IMAGE_RECEIVED, SYNC_UI_STATE, REMOTE_USER_DISCONNECTED_MESSAGE, INTEREST,
