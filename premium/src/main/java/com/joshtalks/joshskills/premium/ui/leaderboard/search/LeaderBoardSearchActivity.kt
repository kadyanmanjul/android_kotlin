package com.joshtalks.joshskills.premium.ui.leaderboard.search
...
import com.joshtalks.joshskills.premium.databinding.ActivityLeaderboardSearchBinding
...
import com.joshtalks.joshskills.premium.track.COURSE_EXPIRY_TIME_IN_MS
import com.joshtalks.joshskills.premium.track.IS_COURSE_BOUGHT
...
class LeaderBoardSearchActivity : BaseActivity() {
    ...
    private fun initRecentSearchRecyclerview() {
        val linearLayoutManager =
            com.joshtalks.joshskills.premium.core.custom_ui.SmoothLinearLayoutManager(this)
