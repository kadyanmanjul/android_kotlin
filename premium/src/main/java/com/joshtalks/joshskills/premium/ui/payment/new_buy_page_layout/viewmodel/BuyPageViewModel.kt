package com.joshtalks.joshskills.premium.ui.payment.new_buy_page_layout.viewmodel
...
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.OFFER_FOR_YOU_TEXT
...
import com.joshtalks.joshskills.premium.ui.errorState.GET_USER_COUPONS_API_ERROR
import com.joshtalks.joshskills.premium.ui.errorState.COURSE_PRICE_LIST_ERROR
import com.joshtalks.joshskills.premium.ui.payment.new_buy_page_layout.FREE_TRIAL_PAYMENT_TEST_ID
import com.joshtalks.joshskills.premium.ui.payment.new_buy_page_layout.adapter.*
...
import com.joshtalks.joshskills.premium.ui.payment.new_buy_page_layout.repo.BuyPageRepo
...
class BuyPageViewModel : BaseViewModel() {
    ...
    suspend fun getCompletedLessonCount(courseId: String = PrefManager.getStringValue(
        CURRENT_COURSE_ID
    )) :Int{
        return try {
