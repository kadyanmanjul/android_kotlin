package com.joshtalks.joshskills.premium.ui.certification_exam.utils
...
class DelayedTypingListener(var delayMillis: Long = DELAY,
                            val action: () -> Unit) : Handler(), TextWatcher {
    companion object {
