...
import com.joshtalks.joshskills.premium.core.AppObjectController.Companion.appDatabase
...
import com.joshtalks.joshskills.premium.core.custom_ui.m4aRecorder.M4ABaseAudioRecording
import com.joshtalks.joshskills.premium.core.custom_ui.recorder.OnAudioRecordListener
import com.joshtalks.joshskills.premium.core.custom_ui.recorder.RecordingItem
...
import com.joshtalks.joshskills.premium.repository.server.PurchaseDataResponse
...
import com.joshtalks.joshskills.premium.repository.server.UpdateLessonResponse
import com.joshtalks.joshskills.premium.repository.server.assessment.AssessmentRequest
import com.joshtalks.joshskills.premium.repository.server.assessment.AssessmentResponse
import com.joshtalks.joshskills.premium.repository.server.assessment.RuleIdsList
...
import com.joshtalks.joshskills.premium.repository.service.NetworkRequestHelper
...
import com.joshtalks.joshskills.premium.ui.referral.WHATSAPP_PACKAGE_STRING
import com.joshtalks.joshskills.premium.ui.voip.new_arch.ui.callbar.CallBar
import com.joshtalks.joshskills.premium.util.AudioRecording
import com.joshtalks.joshskills.premium.util.DeepLinkUtil
import com.joshtalks.joshskills.premium.util.FileUploadService
...
class LessonViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val speakingTooltipLiveData: MutableLiveData<SpeakingTopic> = MutableLiveData()
    ...
    suspend fun getCompletedLessonCountSuspend(courseId: String = PrefManager.getStringValue(
        CURRENT_COURSE_ID
    )) =
