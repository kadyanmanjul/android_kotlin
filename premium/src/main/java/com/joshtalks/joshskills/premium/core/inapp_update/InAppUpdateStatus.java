package com.joshtalks.joshskills.premium.core.inapp_update;
...
public class InAppUpdateStatus {
    ...
    void setAppUpdateInfo(AppUpdateInfo appUpdateInfo) {
        this.appUpdateInfo = appUpdateInfo;
    }

    void setInstallState(InstallState installState) {
