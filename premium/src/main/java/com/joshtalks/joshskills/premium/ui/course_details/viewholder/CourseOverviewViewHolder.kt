...
import com.joshtalks.joshskills.premium.core.IS_SUBSCRIPTION_STARTED
import com.joshtalks.joshskills.premium.core.PrefManager
import com.joshtalks.joshskills.premium.repository.local.eventbus.DownloadSyllabusEvent
import com.joshtalks.joshskills.premium.repository.local.eventbus.OfferCardEvent
import com.joshtalks.joshskills.premium.repository.server.course_detail.CardType
import com.joshtalks.joshskills.premium.repository.server.course_detail.CourseOverviewData
import com.joshtalks.joshskills.premium.repository.server.course_detail.OverviewMediaType
import com.joshtalks.joshskills.premium.repository.server.course_detail.RecyclerViewCarouselItemDecorator
import com.joshtalks.joshskills.premium.ui.inbox.SUBSCRIPTION_COURSE_ID
...
class CourseOverviewViewHolder(
    ...
    fun onResolved() {
        ...
        if (testId == 10 || testId == 122 || !isCourseBought || PrefManager.getBoolValue(
