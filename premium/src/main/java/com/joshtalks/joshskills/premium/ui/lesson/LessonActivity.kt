package com.joshtalks.joshskills.premium.ui.lesson
...
import com.joshtalks.joshskills.premium.constants.*
import com.joshtalks.joshskills.premium.core.*
import com.joshtalks.joshskills.premium.core.ApiCallStatus.*
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.AVAIL_COUPON_BANNER_TEXT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.BUY_COURSE_BANNER_COUPON_UNLOCKED_TEXT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.BUY_COURSE_BANNER_LESSON_TEXT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.COUPON_UNLOCK_LESSON_COUNT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.LESSON_COMPLETE_COUPON_DISCOUNT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.LESSON_SPEAKING_BB_TIP_CONTENT
import com.joshtalks.joshskills.premium.core.FirebaseRemoteConfigKey.Companion.LESSON_SPEAKING_BB_TIP_HEADER
...
import com.joshtalks.joshskills.premium.core.analytics.MarketingAnalytics.lessonNo2Complete
...
import com.joshtalks.joshskills.premium.core.extension.translationAnimationNew
import com.joshtalks.joshskills.premium.core.videotranscoder.enforceSingleScrollDirection
import com.joshtalks.joshskills.premium.core.videotranscoder.recyclerView
import com.joshtalks.joshskills.premium.databinding.LessonActivityBinding
...
import com.joshtalks.joshskills.premium.repository.local.eventbus.MediaProgressEventBus
import com.joshtalks.joshskills.premium.repository.server.PurchasePopupType
import com.joshtalks.joshskills.premium.repository.server.course_detail.VideoModel
...
import com.joshtalks.joshskills.premium.ui.chat.extra.FirstCallBottomSheet
import com.joshtalks.joshskills.premium.ui.leaderboard.ItemOverlay
import com.joshtalks.joshskills.premium.ui.leaderboard.constants.HAS_SEEN_GRAMMAR_ANIMATION
import com.joshtalks.joshskills.premium.ui.lesson.grammar.GrammarFragment
import com.joshtalks.joshskills.premium.ui.lesson.lesson_completed.LessonCompletedActivity
import com.joshtalks.joshskills.premium.ui.lesson.popup.PurchaseDialog
import com.joshtalks.joshskills.premium.ui.lesson.reading.ReadingFragmentWithoutFeedback
import com.joshtalks.joshskills.premium.ui.lesson.reading.ReadingFullScreenFragment
import com.joshtalks.joshskills.premium.ui.lesson.speaking.SpeakingPractiseFragment
import com.joshtalks.joshskills.premium.ui.lesson.speaking.spf_models.UserRating
import com.joshtalks.joshskills.premium.ui.lesson.vocabulary.VocabularyFragment
import com.joshtalks.joshskills.premium.ui.online_test.GrammarAnimation
import com.joshtalks.joshskills.premium.ui.online_test.GrammarOnlineTestFragment
import com.joshtalks.joshskills.premium.ui.online_test.util.A2C1Impressions
import com.joshtalks.joshskills.premium.ui.online_test.util.AnimateAtsOptionViewEvent
...
import com.joshtalks.joshskills.premium.ui.special_practice.utils.L2_CLAIM_NOW_CLICKED
import com.joshtalks.joshskills.premium.ui.special_practice.utils.L2_COUPON_UNLOCKED
import com.joshtalks.joshskills.premium.ui.tooltip.JoshTooltip
import com.joshtalks.joshskills.premium.ui.video_player.IS_BATCH_CHANGED
...
//                )
    ...
    override fun onResume() {
        ...
        PrefManager.put(
            LESSON_ACTIVITY_VISIT_COUNT, PrefManager.getIntValue(
                LESSON_ACTIVITY_VISIT_COUNT
            ).plus(1))
        subscribeRxBus()
    }
...
//                    }
    ...
    fun showBuyCourseTooltip(tabPosition: Int) {
        ...
        when (tabPosition) {
            ...
            VOCAB_POSITION - isTranslationDisabled -> if (PrefManager.getBoolValue(
                    HAS_SEEN_VOCAB_SCREEN
                )
                    .not()
            ) return
            READING_POSITION - isTranslationDisabled -> if (PrefManager.getBoolValue(
                    HAS_SEEN_READING_SCREEN
                )
                    .not()
            ) return
        }
                    ...
                    if (!PrefManager.getBoolValue(HAS_SEEN_SPEAKING_BB_TIP_SHOW) && (tab?.position == 0 || tab?.position == -1)) {
                        ...
                        if (response == null) {
                            ...
                            if (viewModel.abTestRepository.isVariantActive(VariantKeys.SPEAKING_TOOLTIP_V2_ENABLED)) {
                                ...
                                if (introVideoControl && !PrefManager.getBoolValue(
                                        HAS_SEEN_SPEAKING_VIDEO
                                    ) && courseId == "151"){
                                    lifecycleScope.launch(Dispatchers.Main) {
                                        delay(200)
                                        if (introVideoUrl.isNullOrBlank().not()) {
