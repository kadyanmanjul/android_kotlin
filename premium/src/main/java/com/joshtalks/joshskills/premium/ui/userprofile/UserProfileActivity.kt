...
import com.joshtalks.joshskills.premium.constants.MY_GROUP_LIST_DATA
import com.joshtalks.joshskills.premium.constants.ON_BACK_PRESS_PROFILE
...
import com.joshtalks.joshskills.premium.databinding.ActivityUserProfileBinding
import com.joshtalks.joshskills.premium.messaging.RxBus2
import com.joshtalks.joshskills.premium.repository.local.eventbus.AwardItemClickedEventBus
import com.joshtalks.joshskills.premium.repository.local.eventbus.DeleteProfilePicEventBus
import com.joshtalks.joshskills.premium.repository.local.eventbus.SaveProfileClickedEvent
import com.joshtalks.joshskills.premium.repository.local.model.Mentor
import com.joshtalks.joshskills.premium.track.AGORA_UID
import com.joshtalks.joshskills.premium.track.CHANNEL_ID
...
import com.joshtalks.joshskills.premium.ui.group.constants.DM_CHAT
import com.joshtalks.joshskills.premium.ui.group.constants.DM_CHAT_DATA
import com.joshtalks.joshskills.premium.ui.group.model.GroupsItem
import com.joshtalks.joshskills.premium.ui.leaderboard.constants.HAS_SEEN_PROFILE_ANIMATION
import com.joshtalks.joshskills.premium.ui.payment.new_buy_page_layout.BuyPageActivity
import com.joshtalks.joshskills.premium.ui.points_history.PointsInfoActivity
import com.joshtalks.joshskills.premium.ui.senior_student.SeniorStudentActivity
import com.joshtalks.joshskills.premium.ui.userprofile.fragments.*
import com.joshtalks.joshskills.premium.ui.userprofile.models.*
import com.joshtalks.joshskills.premium.ui.userprofile.utils.COURSE
import com.joshtalks.joshskills.premium.ui.userprofile.utils.MY_GROUP
import com.joshtalks.joshskills.premium.ui.userprofile.utils.USER_PROFILE_BACK_STACK
...
//            }
    ...
    private fun initView(userData: UserProfileResponse) {
        ...
        if(helpCountControl && com.joshtalks.joshskills.premium.core.PrefManager.getStringValue(
...
//        showAward(listOf(award), true)
    ...
    override fun onStart() {
        super.onStart()
        if (!com.joshtalks.joshskills.premium.core.PrefManager.getBoolValue(HAS_SEEN_PROFILE_ANIMATION))
    ...
    private fun showOverlayAnimation() {
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            com.joshtalks.joshskills.premium.core.PrefManager.put(HAS_SEEN_PROFILE_ANIMATION, true)
