...
public class JoshSnackBar {
    ...
    private Snackbar make() {
        ...
        TextView actionText = chocolateLayout.findViewById(com.joshtalks.joshskills.R.id.snackbar_action);
        ...
        TextView text = chocolateLayout.findViewById(com.joshtalks.joshskills.R.id.snackbar_text);
