package com.joshtalks.joshskills.premium.core.custom_ui.pdfview
...
import com.joshtalks.joshskills.premium.core.custom_ui.pdfview.subsamplincscaleimageview.SubsamplingScaleImageView.SCALE_TYPE_CENTER_INSIDE
...
internal class PDFRegionDecoder(
    ...
    override fun init(context: Context, uri: Uri): Point {
        ...
        Log.e("pagecount", "" + renderer.pageCount)
        renderer.pageCount
