package com.joshtalks.joshskills.premium.ui.voip.new_arch.ui.utils
...
import com.joshtalks.joshskills.premium.core.BLOCK_STATUS
...
fun isBlocked(): Boolean {
    val blockStatus = CorePrefManager.getBlockStatusObject(com.joshtalks.joshskills.premium.core.BLOCK_STATUS)
    if (CorePrefManager.getIntValue(com.joshtalks.joshskills.premium.core.FT_CALLS_LEFT, defValue = 15) == 0 &&
        CorePrefManager.getBoolValue(com.joshtalks.joshskills.premium.core.IS_FREE_TRIAL))
        return true
