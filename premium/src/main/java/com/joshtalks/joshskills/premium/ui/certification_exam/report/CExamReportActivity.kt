...
import com.joshtalks.joshskills.premium.core.interfaces.FileDownloadCallback
import com.joshtalks.joshskills.premium.core.service.CONVERSATION_ID
import com.joshtalks.joshskills.premium.databinding.ActivityCexamReportBinding
import com.joshtalks.joshskills.premium.messaging.RxBus2
import com.joshtalks.joshskills.premium.core.*
import com.joshtalks.joshskills.premium.repository.local.eventbus.DownloadFileEventBus
import com.joshtalks.joshskills.premium.repository.local.eventbus.GotoCEQuestionEventBus
import com.joshtalks.joshskills.premium.repository.local.eventbus.OpenReportQTypeEventBus
import com.joshtalks.joshskills.premium.repository.server.certification_exam.CertificateExamReportModel
import com.joshtalks.joshskills.premium.repository.server.certification_exam.CertificationExamView
...
import com.joshtalks.joshskills.premium.ui.certification_exam.CERTIFICATION_EXAM_ID
import com.joshtalks.joshskills.premium.ui.certification_exam.CERTIFICATION_EXAM_QUESTION
import com.joshtalks.joshskills.premium.ui.certification_exam.CertificationExamViewModel
import com.joshtalks.joshskills.premium.ui.certification_exam.constants.*
import com.joshtalks.joshskills.premium.ui.certification_exam.examview.CExamMainActivity
import com.joshtalks.joshskills.premium.ui.certification_exam.report.udetail.CertificateDetailActivity
...
class CExamReportActivity : BaseActivity(), FileDownloadCallback {
    ...
    override fun getConversationId(): String? {
        return intent.getStringExtra(com.joshtalks.joshskills.premium.track.CONVERSATION_ID)
    }
                ...
                .subscribe(
                    {
                        ...
                        when (examType){
                            EXAM_TYPE_BEGINNER->{
                                impressionCheck = PrefManager.getBoolValue(
                                    IS_CERTIFICATE_GENERATED_BEGINNER, defValue = true)
                            }
                            EXAM_TYPE_INTERMEDIATE->{
                                impressionCheck = PrefManager.getBoolValue(
                                    IS_CERTIFICATE_GENERATED_INTERMEDIATE, defValue = true)
                            }
                            EXAM_TYPE_ADVANCED->{
                                impressionCheck = PrefManager.getBoolValue(
                                    IS_CERTIFICATE_GENERATED_ADVANCED, defValue = true)
                            }
                        }
                        if (impressionCheck) {
