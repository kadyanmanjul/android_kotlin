...
import com.joshtalks.joshskills.premium.core.LESSON_COMPLETE_SNACKBAR_TEXT_STRING
...
import com.joshtalks.joshskills.premium.repository.local.eventbus.EmptyEventBus
import com.joshtalks.joshskills.premium.repository.local.eventbus.SnackBarEvent
import com.joshtalks.joshskills.premium.repository.local.model.NotificationChannelData
                ...
                if (resp.isSuccessful && resp.body() != null) {
                    ...
                    if (question != null) {
                        ...
                        if (resp.body()!!.pointsList.isNullOrEmpty().not()) {
                            ...
                            com.joshtalks.joshskills.premium.core.PrefManager.put(
                                com.joshtalks.joshskills.premium.core.LESSON_COMPLETE_SNACKBAR_TEXT_STRING,resp.body()!!.pointsList!!.last(),false)
                        }
                    } else {
