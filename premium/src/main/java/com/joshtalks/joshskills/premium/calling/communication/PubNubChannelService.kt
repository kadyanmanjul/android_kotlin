...
import com.joshtalks.joshskills.premium.calling.communication.model.*
import com.joshtalks.joshskills.premium.calling.data.api.CallDisconnectRequest
import com.joshtalks.joshskills.premium.calling.data.api.VoipNetwork
import com.joshtalks.joshskills.premium.calling.data.local.DisconnectCallEntity
import com.joshtalks.joshskills.premium.calling.data.local.PrefManager
import com.joshtalks.joshskills.premium.calling.data.local.SYNCED
...
import com.joshtalks.joshskills.premium.BuildConfig.PUBNUB_PUB_P2P_KEY
import com.joshtalks.joshskills.premium.BuildConfig.PUBNUB_SUB_P2P_KEY
...
class PubNubChannelService(val scope: CoroutineScope) : EventChannel {
    ...
    private fun OutgoingData.captureDisconnectEvent() {
        if(this.getType() == com.joshtalks.joshskills.premium.calling.communication.constants.ServerConstants.DISCONNECTED) {
            try {
                ...
                scope.launch {
                    try{
                        ...
                        data.insertIntoDb(status = com.joshtalks.joshskills.premium.calling.data.local.SYNCED)
