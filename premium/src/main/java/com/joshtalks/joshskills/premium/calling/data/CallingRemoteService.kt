package com.joshtalks.joshskills.premium.calling.data
...
import com.joshtalks.joshskills.premium.calling.constant.Event.CALL_INITIATED_EVENT
import com.joshtalks.joshskills.premium.calling.constant.Event.CLOSE_CALL_SCREEN
import com.joshtalks.joshskills.premium.calling.constant.Event.RECONNECTING_FAILED
import com.joshtalks.joshskills.premium.calling.data.local.PrefManager
import com.joshtalks.joshskills.premium.calling.mediator.CallServiceMediator
import com.joshtalks.joshskills.premium.calling.mediator.CallingMediator
...
import com.joshtalks.joshskills.premium.calling.pstn.PSTNController
import com.joshtalks.joshskills.premium.calling.pstn.PSTNState
import com.joshtalks.joshskills.premium.calling.state.CallConnectData
...
import com.joshtalks.joshskills.premium.calling.mediator.UserAction as Action
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when(intent?.action) {
            ...
            SERVICE_ACTION_INCOMING_CALL -> {
                ...
                map[INCOMING_CALL_CATEGORY] = intent.extras?.getString(INCOMING_CALL_CATEGORY,"")?:""
                map[INTENT_DATA_INCOMING_CALL_ID] = intent.extras?.getString(com.joshtalks.joshskills.premium.calling.constant.INCOMING_CALL_ID,"")?:""
                map[com.joshtalks.joshskills.premium.calling.constant.REMOTE_USER_NAME] = intent.extras?.getString(
                    com.joshtalks.joshskills.premium.calling.constant.REMOTE_USER_NAME,"")?:""
                map[INCOMING_GROUP_NAME] = intent.extras?.getString(INCOMING_GROUP_NAME,"")?:""
                map[INCOMING_GROUP_IMAGE] = intent.extras?.getString(INCOMING_GROUP_IMAGE,"")?:""
                map[IS_PREMIUM_USER] = intent.extras?.getString(IS_PREMIUM_USER,"false") ?: "false"
