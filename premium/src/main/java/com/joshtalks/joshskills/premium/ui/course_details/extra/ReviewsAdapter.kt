package com.joshtalks.joshskills.premium.ui.course_details.extra
...
import com.joshtalks.joshskills.premium.core.getUserNameInShort
import com.joshtalks.joshskills.premium.repository.server.course_detail.Review
...
class ReviewsAdapter(private val reviews: List<Review>) :
    ...
    private fun placeHolder(context: Context, name: String): TextDrawable {
        val font = Typeface.createFromAsset(context.assets, "fonts/JoshOpenSans-Bold.ttf")
