package com.joshtalks.joshskills.common.ui.leaderboard.search
...
import com.joshtalks.joshskills.common.databinding.ActivityLeaderboardSearchBinding
...
class LeaderBoardSearchActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getBooleanExtra(com.joshtalks.joshskills.common.track.IS_COURSE_BOUGHT, false).not() &&
            intent.getLongExtra(com.joshtalks.joshskills.common.track.COURSE_EXPIRY_TIME_IN_MS, -1L) != -1L &&
            intent.getLongExtra(com.joshtalks.joshskills.common.track.COURSE_EXPIRY_TIME_IN_MS, -1L) < System.currentTimeMillis()
        ) {
