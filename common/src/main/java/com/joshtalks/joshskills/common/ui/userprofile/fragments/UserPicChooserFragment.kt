...
import com.joshtalks.joshskills.common.databinding.UserPicChooserDialogBinding
...
class UserPicChooserFragment : BottomSheetDialogFragment() {
    ...
    fun delete() {
        ...
        com.joshtalks.joshskills.common.messaging.RxBus2.publish(DeleteProfilePicEventBus(""))
        dismiss()
    }
