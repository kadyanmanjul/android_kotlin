...
import com.joshtalks.joshskills.common.databinding.FragmentExpertCallUpgradeBinding
import com.joshtalks.joshskills.common.ui.callWithExpert.model.ExpertUpgradeDetails
import com.joshtalks.joshskills.common.ui.callWithExpert.viewModel.CallWithExpertViewModel

class ExpertCallUpgradeFragment : com.joshtalks.joshskills.common.base.BaseFragment() {
    ...
    override fun initViewState() {
        liveData.observe(viewLifecycleOwner) {
            when (it.what) {
                com.joshtalks.joshskills.common.constants.GET_UPGRADE_DETAILS -> setUIData(it.obj as ExpertUpgradeDetails)
            }
        }
    }
