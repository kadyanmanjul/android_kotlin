...
//        }
//        return com.joshtalks.joshskills.auth.freetrail.FreeTrialOnBoardActivity.getIntent(activity)
//    }
//
...
//                activityList.add(Intent(activity, com.joshtalks.joshskills.auth.freetrail.SignUpActivity::class.java))
