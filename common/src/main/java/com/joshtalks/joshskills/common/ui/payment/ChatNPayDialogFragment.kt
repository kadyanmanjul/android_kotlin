...
import com.joshtalks.joshskills.common.databinding.FragmentChatNPayBinding
...
class ChatNPayDialogFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = com.joshtalks.joshskills.common.ui.payment.ChatNPayDialogFragment()
    }
}
