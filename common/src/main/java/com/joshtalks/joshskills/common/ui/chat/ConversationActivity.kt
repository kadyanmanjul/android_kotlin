...
import com.joshtalks.joshskills.common.core.FirebaseRemoteConfigKey.Companion.LESSON_COMPLETE_COUPON_DISCOUNT
import com.joshtalks.joshskills.common.core.Utils.getCurrentMediaVolume
...
import com.joshtalks.joshskills.common.core.extension.setImageWithPlaceholder
import com.joshtalks.joshskills.common.core.extension.setResourceImageDefault
import com.joshtalks.joshskills.common.core.extension.shiftGroupChatIconDown
...
import com.joshtalks.joshskills.common.repository.server.chat_message.TAudioMessage
import com.joshtalks.joshskills.common.repository.server.chat_message.TChatMessage
...
import com.joshtalks.joshskills.common.ui.course_progress_new.CourseProgressActivityNew
...
import com.joshtalks.joshskills.common.ui.practise.PRACTISE_OBJECT
import com.joshtalks.joshskills.common.ui.practise.PractiseSubmitActivity
...
import com.joshtalks.joshskills.common.ui.subscription.TrialEndBottomSheetFragment
...
import com.joshtalks.joshskills.common.util.StickyHeaderDecoration
...
class ConversationActivity :
    ...
    val event = com.joshtalks.joshskills.common.base.EventLiveData
    ...
    private var audioPlayerManager: com.joshtalks.joshskills.common.util.ExoAudioPlayer? = null
...
//        conversationBinding.cbcTooltip.visibility = GONE
    ...
    private fun initEndTrialBottomSheet() {
        com.joshtalks.joshskills.common.ui.subscription.TrialEndBottomSheetFragment.showDialog(
...
//        MixPanelTracker.mixPanel.registerSuperProperties(obj)
    ...
    private fun initRV() {
        ...
        conversationBinding.chatRv.addItemDecoration(
            com.joshtalks.joshskills.common.util.StickyHeaderDecoration(
                conversationAdapter
            ), 0)
    ...
    private fun initFuture() {
        AppAnalytics.create(AnalyticsEvent.COURSE_OPENED.NAME)
            ...
            .push()
        audioPlayerManager = com.joshtalks.joshskills.common.util.ExoAudioPlayer.getInstance()
...
//            showAward(unseenAwards)
    ...
    private fun subscribeRXBus() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(DBInsertion::class.java)
                .subscribeOn(Schedulers.io())
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(PlayVideoEvent::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
                ...
                .subscribe(
                    {
                        Utils.fileUrl(it.localPath, it.serverPath)?.run {
                            com.joshtalks.joshskills.common.ui.extra.ImageShowFragment.newInstance(
                                this,
                                inboxEntity.course_name,
                                it.imageId
                            )
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(PdfOpenEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
...
//        )
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(DownloadMediaEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(DownloadCompletedEventBus::class.java)
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(VideoDownloadedBus::class.java)
                .subscribeOn(Schedulers.computation())
                .subscribe {
                    lifecycleScope.launch(Dispatchers.IO) {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(ChatModel::class.java)
                .subscribeOn(Schedulers.computation())
                .subscribe {
                    visibleItem()
                }
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(MessageCompleteEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(AudioPlayEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
                        ...
                        if (AppObjectController.currentPlayingAudioObject != null && com.joshtalks.joshskills.common.util.ExoAudioPlayer.LAST_ID == it?.chatModel?.chatId) {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(InternalSeekBarProgressEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(PractiseSubmitEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
                        AppAnalytics.create(AnalyticsEvent.PRACTICE_OPENED.NAME)
                            ...
                            .push()
                        com.joshtalks.joshskills.common.ui.practise.PractiseSubmitActivity.startPractiseSubmissionActivity(
                            activityRef.get()!!,
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(GotoChatEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .subscribe(
                    {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(AssessmentStartEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(UnlockNextClassEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(ConversationPractiseEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
                        com.joshtalks.joshskills.common.ui.conversation_practice.ConversationPracticeActivity.startConversationPracticeActivity(
                            this,
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(StartCertificationExamEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .subscribe(
                    {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(SpecialPracticeEventBus::class.java)
                .subscribeOn(Schedulers.computation())
                .subscribe(
                    {
                        Intent(this, SpecialPracticeActivity::class.java).apply {
                            putExtra(SPECIAL_ID, it.specialId)
                            putExtra(com.joshtalks.joshskills.common.track.CONVERSATION_ID, inboxEntity.conversation_id)
                        }.run {
                            startActivity(this)
                        }
                    },
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(LessonItemClickEventBus::class.java)
                .subscribeOn(Schedulers.computation())
                .subscribe(
                    {
                        if (inboxEntity.isCourseBought.not() &&
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(AwardItemClickedEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
//                        showAward(listOf(it.award), true)
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(OpenBestPerformerRaceEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
...
//                }
                ...
                (data?.getParcelableExtra(com.joshtalks.joshskills.common.ui.practise.PRACTISE_OBJECT) as ChatModel?)?.let {
    ...
    override fun onStart() {
        ...
        try {
            conversationViewModel.singleLiveEvent.observe(this) {
                when (it.what) {
                    com.joshtalks.joshskills.common.constants.COURSE_RESTART_SUCCESS -> {
                        logout()
                        showToast(getString(R.string.course_restart_success))
                    }
                    com.joshtalks.joshskills.common.constants.COURSE_RESTART_FAILURE -> {
                        showToast(getString(R.string.course_restart_fail))
                    }
                    com.joshtalks.joshskills.common.constants.INTERNET_FAILURE -> {
                        showToast(getString(R.string.internet_not_available_msz))
                    }
                }
            }
...
//            }
    ...
    private fun openCourseProgressListingScreen() {
        startActivityForResult(
            com.joshtalks.joshskills.common.ui.course_progress_new.CourseProgressActivityNew.getCourseProgressActivityNew(
                this,
                inboxEntity.conversation_id,
        ...
        withContext(Dispatchers.Main) {
            ...
            while (true) {
                ...
                if (view.id == R.id.unlock_class_item_container) {
                    val overlayItem = com.joshtalks.joshskills.common.ui.tooltip.TooltipUtils.getOverlayItemFromView(view)
                    overlayItem?.let {
                        ...
                        val overlayButtonItem = com.joshtalks.joshskills.common.ui.tooltip.TooltipUtils.getOverlayItemFromView(unlockBtnView)
...
//    }
    ...
    fun setOverlayView(
        ...
        val tooltipView =
            conversationBinding.overlayView.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.tooltip)
