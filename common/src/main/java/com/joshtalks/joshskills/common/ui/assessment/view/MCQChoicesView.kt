...
import com.joshtalks.joshskills.common.repository.local.eventbus.McqSubmitEvent
...
import com.joshtalks.joshskills.common.ui.assessment.viewholder.MCQChoiceViewHolder
...
class MCQChoicesView : FrameLayout,
    ...
    private fun addObservers() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(McqSubmitEvent::class.java)
