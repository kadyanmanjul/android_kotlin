...
import com.joshtalks.joshskills.common.repository.local.eventbus.GotoChatEventBus
...
abstract class BaseChatViewHolder(
    ...
    fun addLinkToTagMessage(
        ...
        try {
            ...
            rootView.findViewById<ViewGroup>(R.id.tag_view).setOnClickListener {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(GotoChatEventBus(linkObj.chatId))
            }
    ...
    open fun onViewInflated() {
        com.joshtalks.joshskills.common.messaging.RxBus2.publish(message)
    }
