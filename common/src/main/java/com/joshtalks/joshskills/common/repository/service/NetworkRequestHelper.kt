...
import com.joshtalks.joshskills.common.core.ONLINE_TEST_LAST_LESSON_COMPLETED
...
import com.joshtalks.joshskills.common.repository.server.ChatMessageReceiver
import com.joshtalks.joshskills.common.repository.server.chat_message.BaseChatMessage
import com.joshtalks.joshskills.common.repository.server.chat_message.BaseMediaMessage
    ...
    suspend fun getUpdatedChat(
        ...
        try {
            ...
            if (resp.chatModelList.isNullOrEmpty()) {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(MessageCompleteEventBus(false))
            } else {
                LastSyncPrefManager.put(
                    conversationId.trim(),
                    getTimeInString(resp.chatModelList.last().messageTime)
                )
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(MessageCompleteEventBus(true))
            }
            ...
            if (resp.chatModelList.isEmpty()) {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(DBInsertion("ChatIEmpty"))
            } else {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(DBInsertion("ChatInsert", refreshMessageUser))
            }
