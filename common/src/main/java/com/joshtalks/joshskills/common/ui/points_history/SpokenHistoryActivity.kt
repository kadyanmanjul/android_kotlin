...
class SpokenHistoryActivity : CoreJoshActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spoken_history)
    ...
    private fun initToolbar() {
        ...
        findViewById<AppCompatTextView>(R.id.text_message_title).text = getString(R.string.minutes_history)
    }
