package com.joshtalks.joshskills.common.ui.conversation_practice.fragment
...
import com.joshtalks.joshskills.common.core.interfaces.OnConversationPractiseSubmit
import com.joshtalks.joshskills.common.databinding.FragmentRecordPractiseBinding
...
import com.joshtalks.joshskills.common.repository.server.conversation_practice.ListenModel
...
import com.joshtalks.joshskills.common.ui.conversation_practice.adapter.AudioPractiseAdapter
import com.joshtalks.joshskills.common.ui.conversation_practice.extra.ConversationSubmitBottomSheet
...
class RecordPractiseFragment private constructor() :
    ...
    override fun onDone() {
        com.joshtalks.joshskills.common.messaging.RxBus2.publish(ConversationPractiseSubmitEventBus(getTextWithTalk() ?: EMPTY))
    }
