...
import com.joshtalks.joshskills.common.core.HAS_SEEN_GROUP_CALL_TOOLTIP
import com.joshtalks.joshskills.common.core.PrefManager
import com.joshtalks.joshskills.common.core.hideKeyboard
import com.joshtalks.joshskills.common.databinding.GroupChatFragmentBinding
...
class GroupChatFragment : com.joshtalks.joshskills.common.base.BaseFragment() {
    ...
    override fun initViewState() {
        liveData.observe(viewLifecycleOwner) {
            when (it.what) {
                com.joshtalks.joshskills.common.constants.OPEN_EMOJI_KEYBOARD -> openEmojiKeyboard(it.data)
                com.joshtalks.joshskills.common.constants.CLEAR_CHAT_TEXT -> binding.groupChatSendMsg.setText("")
                com.joshtalks.joshskills.common.constants.SEND_MSG -> vm.pushMessage(binding.groupChatSendMsg.text.toString().trim())
                com.joshtalks.joshskills.common.constants.OPEN_GROUP_INFO -> hideKeyboard(requireContext())
                com.joshtalks.joshskills.common.constants.NEW_CHAT_ADDED -> {
                ...
                com.joshtalks.joshskills.common.constants.REMOVE_DM_FPP -> openRemoveMenu()
            }
        }
    }
    ...
    override fun setArguments() {
        arguments?.let { args ->
            ...
            if (args.getInt(com.joshtalks.joshskills.common.track.AGORA_UID) != 0)
                vm.agoraId = args.getInt(com.joshtalks.joshskills.common.track.AGORA_UID)
