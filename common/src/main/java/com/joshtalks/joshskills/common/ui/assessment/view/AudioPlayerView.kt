package com.joshtalks.joshskills.common.ui.assessment.view
...
class AudioPlayerView : FrameLayout, View.OnClickListener,
    LifecycleObserver,
    com.joshtalks.joshskills.common.util.ExoAudioPlayer.ProgressUpdateListener, AudioPlayerEventListener {
    ...
    private var audioManger: com.joshtalks.joshskills.common.util.ExoAudioPlayer? = null
    ...
    private fun init() {
        ...
        audioManger = com.joshtalks.joshskills.common.util.ExoAudioPlayer.getInstance()
        com.joshtalks.joshskills.common.util.ExoAudioPlayer.LAST_ID = EMPTY
    ...
    private fun playPause(file: File) {
        audioManger?.let {
            if (com.joshtalks.joshskills.common.util.ExoAudioPlayer.LAST_ID.isEmpty()) {
                initAndPlay(file)
                return@let
            }
            if (com.joshtalks.joshskills.common.util.ExoAudioPlayer.LAST_ID == id) {
    ...
    override fun onDetachedFromWindow() {
        ...
        setDefaultValue()
        audioManger?.release()
        com.joshtalks.joshskills.common.util.ExoAudioPlayer.LAST_ID = ""
