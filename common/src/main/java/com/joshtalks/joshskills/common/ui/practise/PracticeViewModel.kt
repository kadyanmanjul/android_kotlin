package com.joshtalks.joshskills.common.ui.practise
...
//                    requestStatusLiveData.postValue(true)
    ...
    fun submitReadingPractise(questionId: String, path: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            com.joshtalks.joshskills.common.util.FileUploadService.uploadSinglePendingTasks(insertedTaskLocalId = insertedId)
        }
    }
