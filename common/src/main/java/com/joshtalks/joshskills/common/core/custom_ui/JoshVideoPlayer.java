...
public class JoshVideoPlayer extends PlayerView implements View.OnTouchListener, View.OnClickListener {
    ...
    private void checkIfFullscreenToggleSupported() {
        ...
        findViewById(R.id.ivFullScreenToggle).setVisibility(View.VISIBLE);
    ...
    public void setFullScreenListener(PlayerFullScreenListener playerFullScreenListener) {
        ...
        findViewById(R.id.ivFullScreenToggleOp).setVisibility(View.VISIBLE);
    ...
    private class PlayerEventListener implements Player.EventListener {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            ...
            if (playbackState == Player.STATE_ENDED && !isVideoEnded) {
                ...
                findViewById(R.id.llControlsContainer).setVisibility(View.GONE);
            }
        }
