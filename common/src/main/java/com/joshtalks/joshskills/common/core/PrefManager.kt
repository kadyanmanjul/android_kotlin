...
const val IS_LEVEL_DETAILS_ENABLED = "IS_LEVEL_DETAILS_ENABLED"
...
const val CONVERSATION_SCREEN_VISIT_COUNT = "CONVERSATION_SCREEN_VISIT_COUNT"
...
object PrefManager {
    ...
    private val prefManagerConsistent: SharedPreferences =
        getPref(AppObjectController.joshApplication, PREF_NAME_CONSISTENT)
