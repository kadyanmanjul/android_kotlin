...
import com.joshtalks.joshskills.common.databinding.FragmentQuizPractiseBinding
import com.joshtalks.joshskills.common.messaging.RxBus2
import com.joshtalks.joshskills.common.repository.local.eventbus.VPPageChangeEventBus
import com.joshtalks.joshskills.common.repository.server.conversation_practice.QuizModel
import com.joshtalks.joshskills.common.ui.conversation_practice.adapter.OnChoiceClickListener2
import com.joshtalks.joshskills.common.ui.conversation_practice.adapter.QuizPractiseAdapter
    ...
    fun submit() {
        if (isEvaluate) {
            if (binding.viewPager.currentItem == (quizModelList.size - 1)) {
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(VPPageChangeEventBus())
            }
