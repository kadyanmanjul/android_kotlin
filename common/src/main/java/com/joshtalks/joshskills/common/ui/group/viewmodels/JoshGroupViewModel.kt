...
import com.joshtalks.joshskills.common.core.ONE_GROUP_REQUEST_SENT
...
import com.joshtalks.joshskills.common.ui.group.constants.SHOW_NEW_INFO
...
import com.joshtalks.joshskills.common.ui.group.constants.OPENED_GROUP
...
class JoshGroupViewModel : com.joshtalks.joshskills.common.base.BaseViewModel() {
    ...
    fun showImageThumb(imagePath: String) {
        message.what = com.joshtalks.joshskills.common.constants.GROUP_IMAGE_SELECTED
    ...
    fun onSearch() {
        ...
        message.what = com.joshtalks.joshskills.common.constants.SEARCH_GROUP
        singleLiveEvent.value = message
    }
    ...
    fun onMoreOption() {
        ...
        message.what = com.joshtalks.joshskills.common.constants.OPEN_POPUP_MENU
        singleLiveEvent.value = message
    }
    ...
    fun openImageChooser(view: View) {
        message.what = com.joshtalks.joshskills.common.constants.OPEN_IMAGE_CHOOSER
        singleLiveEvent.value = message
    }

    fun saveGroupInfo(view: View) {
        if (isFromGroupInfo.get()) {
            message.what = com.joshtalks.joshskills.common.constants.SAVE_GROUP_INFO
            singleLiveEvent.value = message
        } else {
            message.what = com.joshtalks.joshskills.common.constants.CREATE_GROUP_VALIDATION
            singleLiveEvent.value = message
        }
    }

    fun openAdminResponsibility(request: AddGroupRequest) {
        message.what = com.joshtalks.joshskills.common.constants.OPEN_ADMIN_RESPONSIBILITY
        message.obj = request
        singleLiveEvent.value = message
    ...
    fun createGroup(view: View) {
        message.what = com.joshtalks.joshskills.common.constants.ADD_GROUP_TO_SERVER
        singleLiveEvent.value = message
    }
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    if (isSuccess) {
                        message.what =
                            com.joshtalks.joshskills.common.constants.SHOULD_REFRESH_GROUP_LIST
                        singleLiveEvent.value = message
                        onBackPress()
                        onBackPress()
                    }
    ...
    fun setGroupsCount() = viewModelScope.launch(Dispatchers.IO) {
        ...
        withContext(Dispatchers.Main) {
            if ((groupListCount.get() ?: 0) > 3) {
                message.what = com.joshtalks.joshskills.common.constants.INIT_LIST_TOOLTIP
                singleLiveEvent.value = message
            }
        }
    }
