...
import com.joshtalks.joshskills.common.repository.local.eventbus.MatchTheFollowingSubmitEvent
...
import com.joshtalks.joshskills.common.ui.assessment.listener.EmptyListListener
...
class MatchTheFollowingChoiceView : FrameLayout,
    ...
    private fun addObservers() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(MatchTheFollowingSubmitEvent::class.java)
