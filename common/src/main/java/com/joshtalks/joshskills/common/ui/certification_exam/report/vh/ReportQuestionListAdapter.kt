...
import com.joshtalks.joshskills.common.databinding.QuestionListItemViewBinding
        ...
        fun bind(obj: UserSelectedAnswer, position: Int) {
            with(binding) {
                ...
                frameLayout.setOnClickListener {
                    ...
                    com.joshtalks.joshskills.common.messaging.RxBus2.publish(GotoCEQuestionEventBus(obj.question))
                }
            }
        }
