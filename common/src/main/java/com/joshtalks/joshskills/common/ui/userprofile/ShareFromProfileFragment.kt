...
import com.joshtalks.joshskills.common.databinding.FragmentShareFromProfileBinding
import com.joshtalks.joshskills.common.ui.userprofile.viewmodel.UserProfileViewModel

class ShareFromProfileFragment : com.joshtalks.joshskills.common.base.BaseFragment() {
    ...
    override fun initViewState() {
        liveData.observe(viewLifecycleOwner) {
            when (it.what) {
                com.joshtalks.joshskills.common.constants.INVITE_FRIENDS_METHOD -> inviteFriends(it.obj as Intent)
            }
        }
    }
