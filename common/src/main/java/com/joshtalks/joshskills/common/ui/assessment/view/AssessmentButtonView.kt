...
import com.joshtalks.joshskills.common.repository.local.eventbus.AssessmentButtonClick
import com.joshtalks.joshskills.common.repository.local.eventbus.AssessmentButtonClickEvent
import com.joshtalks.joshskills.common.repository.local.eventbus.AssessmentButtonStateEvent
...
class AssessmentButtonView : FrameLayout {
    ...
    private fun addListeners() {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(AssessmentButtonStateEvent::class.java)
