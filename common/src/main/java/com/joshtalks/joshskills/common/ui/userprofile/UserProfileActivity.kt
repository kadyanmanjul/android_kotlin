...
import com.joshtalks.joshskills.common.ui.userprofile.fragments.*
import com.joshtalks.joshskills.common.ui.userprofile.models.*
import com.joshtalks.joshskills.common.ui.userprofile.utils.COURSE
import com.joshtalks.joshskills.common.ui.userprofile.utils.MY_GROUP
import com.joshtalks.joshskills.common.ui.userprofile.utils.USER_PROFILE_BACK_STACK
...
class UserProfileActivity : CoreJoshActivity() {
    ...
    private val liveData = com.joshtalks.joshskills.common.base.EventLiveData
...
//        showAward(listOf(award), true)
    ...
    override fun onStart() {
        ...
        liveData.observe(this) {
            when (it.what) {
                com.joshtalks.joshskills.common.constants.ON_BACK_PRESS_PROFILE -> {
                    popBackStack()
                }
                com.joshtalks.joshskills.common.constants.COURSE_LIST_DATA -> {
                    showCourseList(it.obj as EnrolledCoursesList)
                }
                com.joshtalks.joshskills.common.constants.MY_GROUP_LIST_DATA -> {
