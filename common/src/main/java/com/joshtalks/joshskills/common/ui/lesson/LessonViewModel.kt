...
class LessonViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun permissionGranted() {
        message.what = com.joshtalks.joshskills.common.constants.PERMISSION_FROM_READING_GRANTED
        singleLiveEvent.value = message
    }

    fun askStoragePermission() {
        message.what = com.joshtalks.joshskills.common.constants.PERMISSION_FROM_READING
        singleLiveEvent.value = message
    }
    ...
    fun sendOutputToFullScreen(output: String) {
        message.what = com.joshtalks.joshskills.common.constants.SEND_OUTPUT_FILE
        message.obj = output
        singleLiveEvent.value = message
    }

    fun submitButton() {
        message.what = com.joshtalks.joshskills.common.constants.SUBMIT_BUTTON_CLICK
        singleLiveEvent.value = message
    }

    fun cancelButton() {
        message.what = com.joshtalks.joshskills.common.constants.CANCEL_BUTTON_CLICK
        singleLiveEvent.value = message
    }

    fun closeVideoView() {
        message.what = com.joshtalks.joshskills.common.constants.CLOSE_VIDEO_VIEW
        singleLiveEvent.value = message
    }
    ...
    fun showVideoView() {
        if (isVideoMuxFailed) {
            ...
            message.what = com.joshtalks.joshskills.common.constants.SHOW_VIDEO_VIEW
            singleLiveEvent.value = message
        }
    }

    fun showAudioView() {
        message.what = com.joshtalks.joshskills.common.constants.SHOW_AUDIO_ONLY
        singleLiveEvent.value = message
    }
