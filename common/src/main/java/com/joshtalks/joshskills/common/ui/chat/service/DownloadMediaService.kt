package com.joshtalks.joshskills.common.ui.chat.service
...
import com.joshtalks.joshskills.common.ui.voip.util.NotificationId
        ...
        downloadService.execute {
            ...
            tag?.let {
                if (chatModel == null) {
                    ...
                    com.joshtalks.joshskills.common.messaging.RxBus2.publish(DownloadMediaEventBus(DOWNLOAD_STATUS.DOWNLOADED, it, type))
                }
            }
            if (downloadCount == 0) {
                removeNotifications()
