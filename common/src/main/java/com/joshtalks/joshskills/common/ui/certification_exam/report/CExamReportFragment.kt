package com.joshtalks.joshskills.common.ui.certification_exam.report
...
import com.joshtalks.joshskills.common.databinding.FragmentCexamReportBinding
...
import com.joshtalks.joshskills.common.ui.certification_exam.CERTIFICATION_EXAM_QUESTION
import com.joshtalks.joshskills.common.ui.certification_exam.CertificationExamViewModel
import com.joshtalks.joshskills.common.ui.certification_exam.constants.CHECK_EXAM_DETAILS
import com.joshtalks.joshskills.common.ui.certification_exam.report.vh.ReportOverviewView1
import com.joshtalks.joshskills.common.ui.certification_exam.report.vh.ReportOverviewView2
import com.joshtalks.joshskills.common.ui.certification_exam.report.vh.ReportOverviewView3
...
class CExamReportFragment : Fragment() {
    ...
    private fun addObserver() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(EmptyEventBus::class.java)
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(OpenReportQTypeEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(GotoCEQuestionEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .subscribe({
                    viewModel.isSAnswerUiShow = false
                    binding.tempFl.visibility = View.GONE
