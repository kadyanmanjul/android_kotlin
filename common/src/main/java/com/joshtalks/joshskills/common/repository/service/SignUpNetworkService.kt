...
import com.joshtalks.joshskills.common.repository.server.onboarding.EnrollMentorWithTagIdRequest
import com.joshtalks.joshskills.common.repository.server.onboarding.EnrollMentorWithTestIdRequest
import com.joshtalks.joshskills.common.repository.server.onboarding.LogGetStartedEventRequest
import com.joshtalks.joshskills.common.repository.server.onboarding.OnBoardingStatusResponse
import com.joshtalks.joshskills.common.repository.server.signup.LoginResponse
import com.joshtalks.joshskills.common.repository.server.signup.RequestSocialSignUp
import com.joshtalks.joshskills.common.repository.server.signup.RequestUserVerification
...
interface SignUpNetworkService {
    ...
    @POST("${DIR}/payment/create_wallet_order")
    fun createWalletOrder(@Body params: Map<String, String?>): Deferred<Response<JuspayPayLoad>>
