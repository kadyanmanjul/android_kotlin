...
import com.joshtalks.joshskills.common.databinding.ActivityCexamReportBinding
...
import com.joshtalks.joshskills.common.ui.certification_exam.CERTIFICATION_EXAM_ID
...
import com.joshtalks.joshskills.common.ui.certification_exam.constants.*
import com.joshtalks.joshskills.common.ui.certification_exam.examview.CExamMainActivity
import com.joshtalks.joshskills.common.ui.certification_exam.report.udetail.CertificateDetailActivity
...
class CExamReportActivity : BaseActivity(), FileDownloadCallback {
    ...
    private fun addRxbusObserver() {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(DownloadFileEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    {
