...
import com.joshtalks.joshskills.common.databinding.FragmentGroupSearchBinding
import com.joshtalks.joshskills.common.track.CONVERSATION_ID
import com.joshtalks.joshskills.common.ui.group.constants.IS_FROM_VOIP
import com.joshtalks.joshskills.common.ui.group.viewmodels.GroupSearchViewModel
import kotlinx.coroutines.FlowPreview
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.flow.distinctUntilChanged

class GroupSearchFragment : com.joshtalks.joshskills.common.base.BaseFragment() {
    ...
    override fun initViewState() {
        liveData.observe(viewLifecycleOwner) {
            when(it.what) {
                com.joshtalks.joshskills.common.constants.CLEAR_SEARCH -> {
    ...
    override fun setArguments() {
        arguments.let {
            ...
            vm.conversationId = it?.getString(com.joshtalks.joshskills.common.track.CONVERSATION_ID, "") ?: ""
        }
    }
