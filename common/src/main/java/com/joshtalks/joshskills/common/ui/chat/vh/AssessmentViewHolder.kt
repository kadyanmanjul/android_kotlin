...
import com.joshtalks.joshskills.common.repository.local.eventbus.AssessmentStartEventBus
...
class AssessmentViewHolder(view: android.view.View, userId: String) : BaseViewHolder(view, userId) {
    ...
    private fun fireInTheHole() {
        message?.let {
            com.joshtalks.joshskills.common.messaging.RxBus2.publish(AssessmentStartEventBus(it.chatId, it.question?.assessmentId ?: 0))
        }
    }
