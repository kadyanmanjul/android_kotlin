package com.joshtalks.joshskills.common.ui.conversation_practice
...
import com.joshtalks.joshskills.common.core.ViewTypeForPractiseUser
...
import com.joshtalks.joshskills.common.databinding.ActivityConversationPractice2Binding
import com.joshtalks.joshskills.common.messaging.RxBus2
import com.joshtalks.joshskills.common.repository.local.eventbus.ConversationPractiseSubmitEventBus
import com.joshtalks.joshskills.common.repository.local.eventbus.VPPageChangeEventBus
...
import com.joshtalks.joshskills.common.ui.conversation_practice.adapter.PractiseViewPagerAdapter
import com.joshtalks.joshskills.common.ui.conversation_practice.extra.ConversationPracticeIntro
import com.joshtalks.joshskills.common.ui.conversation_practice.history.SubmittedPractiseActivity
...
class ConversationPracticeActivity : CoreJoshActivity() {
    ...
    private fun subscribeBus() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(ViewPagerDisableEventBus::class.java)
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(ConversationPractiseSubmitEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listen(VPPageChangeEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({
