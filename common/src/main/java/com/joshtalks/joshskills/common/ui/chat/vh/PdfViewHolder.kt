...
import com.joshtalks.joshskills.common.core.custom_ui.ShimmerImageView
import com.joshtalks.joshskills.common.core.custom_ui.custom_textview.JoshTextView
import com.joshtalks.joshskills.common.core.extension.setImageViewPH
        ...
        message?.let {
            it.question?.pdfList?.getOrNull(0)?.let { pdfObj ->
                ...
                JoshSkillExecutors.BOUNDED.submit {
                    ...
                    com.joshtalks.joshskills.common.messaging.RxBus2.publish(PdfOpenEventBus(it.chatId, pdfObj))
                }
            }
        }
    }
