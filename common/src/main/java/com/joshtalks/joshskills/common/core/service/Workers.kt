    ...
    override suspend fun doWork(): Result {
        try {
            ...
            AppObjectController.appDatabase.favoriteCallerDao().also {
                ...
                com.joshtalks.joshskills.common.messaging.RxBus2.publish(DBInsertion("Favorite_caller"))
            }
        } catch (ex: Throwable) {
            LogException.catchException(ex)
        }
        ...
        try {
            ...
            val list = sessionList.parallelStream()
                .map { courseUsageModel ->
                    com.joshtalks.joshskills.common.track.CourseUsageSync(
            ...
            val body: HashMap<String, List<com.joshtalks.joshskills.common.track.CourseUsageSync>> = HashMap()
            body["data"] = list
