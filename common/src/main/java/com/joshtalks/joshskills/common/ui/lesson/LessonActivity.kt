...
import com.joshtalks.joshskills.common.core.analytics.MarketingAnalytics.lessonNo2Complete
...
import com.joshtalks.joshskills.common.ui.lesson.reading.ReadingFullScreenFragment
...
class LessonActivity : CoreJoshActivity(), LessonActivityListener,
    com.joshtalks.joshskills.common.ui.online_test.GrammarAnimation {
...
//                )
    ...
    private fun subscribeRxBus() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(com.joshtalks.joshskills.common.ui.online_test.util.AnimateAtsOptionViewEvent::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe { event ->
                    com.joshtalks.joshskills.common.ui.online_test.vh.AtsOptionView(
                        this,
                        event.atsOptionView.choice
                    ).apply {
...
//                    binding.lessonSpotlightTooltip.visibility = View.VISIBLE
                    ...
                    videoView.apply {
                        ...
                        setPlayerCompletionCallback {
                            if (it.id != INTRO_VIDEO_ID) {
                                ...
                                com.joshtalks.joshskills.common.ui.online_test.util.A2C1Impressions.saveImpression(
                                    com.joshtalks.joshskills.common.ui.online_test.util.A2C1Impressions.Impressions.RULE_VIDEO_COMPLETED)
                            }
                        }
                        seekToStart()
                        downloadStreamPlay()
    ...
    private fun setUpTabLayout(
        ...
        if (PrefManager.getBoolValue(IS_COURSE_BOUGHT) && lessonIsNewGrammar &&
            ...
            arrayFragment.add(TRANSLATION_POSITION, com.joshtalks.joshskills.common.ui.online_test.GrammarOnlineTestFragment.getInstance(lessonNo))
            com.joshtalks.joshskills.common.ui.online_test.util.A2C1Impressions.saveImpression(com.joshtalks.joshskills.common.ui.online_test.util.A2C1Impressions.Impressions.START_LESSON_CLICKED)
            isTranslationDisabled = 0
        } else if (lessonIsNewGrammar) {
            arrayFragment.add(GRAMMAR_POSITION, com.joshtalks.joshskills.common.ui.online_test.GrammarOnlineTestFragment.getInstance(lessonNo))
        } else {
            arrayFragment.add(GRAMMAR_POSITION, GrammarFragment.getInstance())
        }
...
//                merged_video.stopPlayback()
    ...
    override fun showGrammarAnimation(overlayItem: TooltipUtils.ItemOverlay) {
        ...
        val tooltipView = binding.itemOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.tooltip)
        tooltipView.visibility = View.INVISIBLE
    ...
    private fun setUpVideoProgressListener() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(MediaProgressEventBus::class.java)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                    { mediaProgressEvent ->
