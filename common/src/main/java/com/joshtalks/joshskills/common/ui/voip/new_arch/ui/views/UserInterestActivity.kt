...
class UserInterestActivity : com.joshtalks.joshskills.common.base.BaseActivity() {
    ...
    override fun initViewState() {
        event.observe(this){
            when(it.what){
                com.joshtalks.joshskills.common.constants.START_USER_INTEREST_FRAGMENT -> addInterestFragment()

                com.joshtalks.joshskills.common.constants.CLOSE_INTEREST_ACTIVITY -> finish()
