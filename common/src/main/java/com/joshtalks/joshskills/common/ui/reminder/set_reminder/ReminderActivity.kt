...
import com.joshtalks.joshskills.common.core.FirebaseRemoteConfigKey.Companion.SET_REMINDER_DESCRIPTION
...
import com.joshtalks.joshskills.common.databinding.ActivityReminderBinding
...
class ReminderActivity : CoreJoshActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.extras != null) {
            ...
            if (intent.hasExtra("frequency")) {
                ...
                when {
                    com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.EVERYDAY.name == frequency -> binding.everydayChip.isChecked =
                        true
                    com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.WEEKENDS.name == frequency -> binding.weekendChip.isChecked =
                        true
                    com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.WEEKDAYS.name == frequency -> binding.weekdaysChip.isChecked =
                        true
                }
            }
        } else {
        ...
        binding.createReminderBtn.setOnClickListener {
            ...
            viewModel.submitReminder(
                ...
                com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderStatus.ACTIVE.name,
    ...
    private fun getReminderFrequency(): com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency {
        return when (binding.repeatModeChips.checkedChipId) {
            R.id.weekdays_chip -> {
                com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.WEEKDAYS
            }
            R.id.weekend_chip -> {
                com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.WEEKENDS
            }
            else -> {
                com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderFrequency.EVERYDAY
            }
        }
    }
