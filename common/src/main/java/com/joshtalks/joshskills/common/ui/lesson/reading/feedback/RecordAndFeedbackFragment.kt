...
import com.joshtalks.joshskills.common.databinding.FragmentRecordFeedbackBinding
...
class RecordAndFeedbackFragment : Fragment(), OnAudioRecordListener {
    ...
    private val practiceViewModel: com.joshtalks.joshskills.common.ui.practise.PracticeViewModel by lazy {
        ViewModelProvider(requireActivity()).get(com.joshtalks.joshskills.common.ui.practise.PracticeViewModel::class.java)
    }
