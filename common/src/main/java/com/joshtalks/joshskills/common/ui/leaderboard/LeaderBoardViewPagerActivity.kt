...
import com.joshtalks.joshskills.common.databinding.ActivityLeaderboardViewPagerBinding
import com.joshtalks.joshskills.common.messaging.RxBus2
import com.joshtalks.joshskills.common.repository.local.eventbus.OpenPreviousLeaderboard
import com.joshtalks.joshskills.common.repository.local.model.Mentor
import com.joshtalks.joshskills.common.repository.server.LeaderboardMentor
import com.joshtalks.joshskills.common.repository.server.LeaderboardResponse
import com.joshtalks.joshskills.common.track.CONVERSATION_ID
import com.joshtalks.joshskills.common.ui.leaderboard.constants.*
import com.joshtalks.joshskills.common.ui.leaderboard.search.LeaderBoardSearchActivity
...
class LeaderBoardViewPagerActivity : CoreJoshActivity(), ViewBitmap {
    ...
    private fun subscribeRXBus() {
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(OpenPreviousLeaderboard::class.java)
            ...
            if (isActive) {
                withContext(Dispatchers.Main) {
                    if (PrefManager.getBoolValue(HAS_SEEN_LEADERBOARD_ITEM_ANIMATION, true)) {
                        ...
                        delay(100)
                        val tooltipView =
                            binding.tabOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.tooltip)
                        val batchTooltipView =
                            binding.tabOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.batch_tooltip)
                        val topLayout =
...
//                        delay(1250)
    ...
    private fun showWinnerOverlay(
        ...
        tooltipView: com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip
    ) {
    ...
    @MainThread
    private fun showToolTip(tooltipView: com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip, tooltipText: String) {
...
//            delay(6500)
    ...
    private fun hideTabOverlay() {
        val tooltipView = binding.tabOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.tooltip)
        ...
        val batchTooltipView = binding.tabOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.batch_tooltip)
    ...
    private fun hideItemTabOverlay() {
        val tooltipView = binding.itemTabOverlay.findViewById<com.joshtalks.joshskills.common.ui.tooltip.JoshTooltip>(R.id.tooltip)
