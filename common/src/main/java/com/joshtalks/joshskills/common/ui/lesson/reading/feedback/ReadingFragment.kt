package com.joshtalks.joshskills.common.ui.lesson.reading.feedback
...
import com.joshtalks.joshskills.common.databinding.ReadingPracticeFragmentBinding
...
import com.joshtalks.joshskills.common.repository.local.entity.practise.PractiseType
...
import com.joshtalks.joshskills.common.ui.translation.LanguageTranslationDialog
...
class ReadingFragment : CoreJoshFragment(), ReadingPractiseCallback {
    ...
    private fun subscribeRxBusObserver() {
        ...
        compositeDisposable.add(
            com.joshtalks.joshskills.common.messaging.RxBus2.listenWithoutDelay(ViewPagerDisableEventBus::class.java)
                .subscribeOn(Schedulers.io())
