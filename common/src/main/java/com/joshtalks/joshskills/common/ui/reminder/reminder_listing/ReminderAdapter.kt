...
class ReminderAdapter(
    var context: Context,
    private var onStatusUpdate: ((status: com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderStatus, reminderItem: ReminderResponse) -> Unit)? =
        null,
    ...
    override fun onBindViewHolder(holder: ReminderViewHolder, position: Int) {
        ...
        if (reminderItem.status == com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderStatus.ACTIVE.name) {
        ...
        holder.statusSw.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked)
                onStatusUpdate?.invoke(
                    com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderStatus.ACTIVE,
                    getItem(position)
                )
            else {
                onStatusUpdate?.invoke(
                    com.joshtalks.joshskills.common.util.ReminderUtil.Companion.ReminderStatus.INACTIVE,
                    getItem(position)
                )
            }
        }
