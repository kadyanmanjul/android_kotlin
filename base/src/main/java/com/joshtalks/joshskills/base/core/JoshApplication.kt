...
class JoshApplication :
    ...
    override fun onCreate() {
        ...
        if (isMainProcess()) {
            ...
            //TODO: move VoipPref? -- VoipPref.initVoipPref(this)
            ...
            initGroups()
                ...
                //TODO : Utils.kt of voip module -- Utils.initUtils(this)
    ...
    private fun initMoEngage() {
        val moEngage = MoEngage.Builder(this, "DU9ICNBN2A9TTT38BS59KEU6")
            ...
            /* TODO: Resources not available
            .configureNotificationMetaData(
                NotificationConfig(R.drawable.ic_status_bar_notification, R.mipmap.ic_launcher_round)
            )*/
            .build()
...
//        intentFilter.addAction("android.net.conn.CONNECTIVITY_CHANGE")
        ...
        //TODO: -- registerReceiver(ServiceStartReceiver(), intentFilter)

        /* TODO: JoshSkillExecutors not available
    ...
    fun onAppForegrounded() {
        ...
        isAppVisible = true
        /* TODO: WorkManagerAdmin, ReminderUtil not available
    ...
    private fun removeAlarmReminder(delay: Int) {
        ...
        if (alarmManager != null) {
            /* TODO: LocalNotificationAlarmReciever not available
    ...
    fun onAppBackgrounded() {
        ...
        /* TODO: Check getConditionForShowLocalNotifications(), WorkManagerAdmin and ReminderUtil
        WorkManagerAdmin.userAppUsage(isAppVisible)
    ...
    private fun setAlarmReminder(delay: Int) {
        ...
        /* TODO: import NOTIFICATION_DELAY constant
        alarmManager.set(
...
/*
    TODO: import FirebaseRemoteConfigKey class
    ...
    fun onAppDestroy() {
        ...
        //TODO : -- PstnObserver.unregisterPstnReceiver()
    }
